  ...
  return (
    <section className={cn("relative w-full mt-0 overflow-hidden", className)}>
      <footer className="bg-background relative">
        <div className="max-w-7xl flex flex-col justify-between mx-auto min-h-[30rem] sm:min-h-[25rem] md:min-h-[25rem] relative p-4 py-10">
          ...
          <div className="mt-20 md:mt-24 flex flex-col gap-2 md:gap-1 items-center justify-center md:flex-row md:items-center md:justify-between px-4 md:px-0">
            ...
            <div className="flex flex-col gap-2  md:gap-1 items-center md:flex-row md:items-center md:justify-between">
    ...
    absolute left-1/2 -translate-x-1/2 bottom-40 md:bottom-32 
    font-extrabold tracking-tighter pointer-events-none select-none 
    text-center px-4

    whitespace-normal        /* allow wrapping on mobile */
    sm:whitespace-nowrap     /* prevent wrapping on tablet+ */
  "
          style={{
            fontSize: "clamp(7rem, 12vw, 20rem)",
            maxWidth: "95vw",
          }}
        >
          {brandName.toUpperCase()}
